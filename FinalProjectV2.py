...
def check():
    ...
    if flag == 17:
        winsound.PlaySound('ridiculous', winsound.SND_FILENAME)
...
btn6 = Button(window, text=" ", bg= "black", fg="yellow",width=3,height=1,font=('Helvetica','20'),command=clicked6)
...
btn10 = Button(window, text=" ",bg="black", fg="yellow", width=3, height=1,font=('Helvetica','20'),command=clicked10)
btn10.grid(column=2, row = 3)

btn11 = Button(window, text=" ",bg="black", fg="yellow", width=3, height=1,font=('Helvetica','20'),command=clicked11)
